...
public class ParametersParserTest
{
    ...
    @Parameter(2)
    public org.e1c.edt.ai.assistent.model.Parameters expectedParameters;
    ...
    {
        // @formatter:off
        var defaultParams = createParams(p -> {; });
    ...
    private static org.e1c.edt.ai.assistent.model.Parameters createParams(
