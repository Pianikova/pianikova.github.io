...
import org.e1c.edt.ai.ConfidenceInterval;
import org.e1c.edt.ai.ConfidenceIntervalType;
import org.e1c.edt.ai.IClock;
import org.e1c.edt.ai.IMath;
import org.e1c.edt.ai.ISample;
import org.e1c.edt.ai.InputDelayStatistics;
...
public class InputDelayStatisticsTest
{
    ...
    {
        return new InputDelayStatistics(sample, clock, math, 2, MIN_DELAY, MAX_DELAY,
            DEFAULT_DELAY, INPUT_CONFIDENCE_LEVEL, PREDICT_CONFIDENCE_LEVEL);
    }
