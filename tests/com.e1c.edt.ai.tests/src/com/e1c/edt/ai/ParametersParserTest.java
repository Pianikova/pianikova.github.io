    ...
    public static Collection<Object[]> data()
    {
        ...
        return Arrays.asList(
            new Object[][] {
                ...
                { "experimental=true", ValidationResult.SUCCESS, createParams(p -> { p.experimental = Optional.of(true); } ) },
                { "experimental=false", ValidationResult.SUCCESS, createParams(p -> { p.experimental = Optional.of(false); } ) },
