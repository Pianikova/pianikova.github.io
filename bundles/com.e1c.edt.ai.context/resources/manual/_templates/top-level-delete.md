...
- ⛔ Before deleting, confirm the target project is writable: `GetProjects` must show `read_only: false`. If `read_only: true` (full vendor support), do NOT run this workflow — including via JShell — see `readonly_configuration`.
