...
|---|---|
| Top-level create/edit/delete | Run `GetMarkers` with `marker_type: "1c"` before reporting success. Any new relevant marker for the changed object means the operation is incomplete, regardless of severity. |
