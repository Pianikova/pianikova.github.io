    ...
    implements IMcpTool
{
    ...
    private String buildDescription()
    {
        ...
        sb.append("For 1C metadata CRUD, after every JShell create, update/edit, or delete, the mandatory next tool is ")
            ...
            .append(" with `marker_type: \"1c\"` for the affected project. Check all relevant markers for the changed entity, ")
            .append("including errors, warnings, and infos; do not check only errors. Do not report success and do not start ")
            .append("the next CRUD operation before checking markers.\n");
