...
public interface IEditingSupport
{
     ...
     * support ({@code ObjectBelonging.ADOPTED}). Extension projects are never read-only
     * by this rule. Indeterminate states (project closed, V8 model not loaded yet,
     * non-1C project) return {@code false}.
     */
